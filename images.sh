...
#getting information about docker images into a variable; reading only 2nd line of the command output, bc 1st line contains only headers;
images=$(docker image ls | tail -n +2)
...
while read -r line; do
        ...
        size=$(echo $line | awk -F" " '{print $7}') #size in MB
